#' @title World Fire Weather Index for CFS seasonal forecast
#' 
...
wfwi_cfs_op <- function(dataset, mask = NULL, dictionary = TRUE, 
                     members = NULL, season = NULL,
                     years = NULL, leadMonth = 1, return.all = FALSE, init.pars = c(85, 6, 15),
                     parallel = FALSE,
                     max.ncores = 16,
                     ncores = NULL){
